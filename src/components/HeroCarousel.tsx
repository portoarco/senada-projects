...
const HeroCarousel = () => {
  ...
  return (
    <section className="relative w-full h-[500px] md:h-[600px] lg:h-[700px] bg-foreground overflow-hidden">
      {/* Background Images */}
      ...
      {showAbout && (
        <div className="absolute inset-0 z-40 flex items-center justify-center bg-foreground/95 backdrop-blur-md animate-in fade-in duration-500">
          ...
          <div className="max-w-3xl text-center px-6 text-white space-y-6">
            ...
            <p className="text-xl text-primary uppercase tracking-[0.3em] font-medium">
